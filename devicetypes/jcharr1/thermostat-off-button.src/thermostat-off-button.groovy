metadata {
	...
	definition (name: "Thermostat Off Button", namespace: "jcharr1", author: "Jason Charrier") {
		capability "Actuator"
		capability "Button"
		capability "Sensor"
	...
	tiles {
		standardTile("button", "device.button", width: 1, height: 1) {
			state "default", label: "Off", icon: "st.thermostat.heating-cooling-off", backgroundColor: "#ffffff"
		}
